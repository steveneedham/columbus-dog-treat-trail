...
export function Brand({ subtitle, logoSrc = 'assets/logo-lockup.svg', mascot = false, mascotSrc = 'assets/mascot/scout-mark.svg' }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      {mascot ? <img src={mascotSrc} alt="" style={{ height: 36, width: 36, display: 'block' }} /> : null}
